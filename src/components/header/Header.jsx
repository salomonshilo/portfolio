...
const Header = () => {
    ...
    const [activeNav, setAcctiveNav] = useState("#home")
  return (
        ...
        <div className={Toggle ? "nav_menu show-menu" : "nav_menu"}>
          <ul className="nav_list grid">
            ...
            <li className="nav_item">
              <a
                href="#services"
                onClick={() => setAcctiveNav("#services")}
                className={
                  activeNav === "#services"
            ...
            <li className="nav_item">
              <a
                href="#porfolio"
                onClick={() => setAcctiveNav("#porfolio")}
                className={
                  activeNav === "#porfolio"
                    ? "nav_link  active-link"
                    : "nav_link"
